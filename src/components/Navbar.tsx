          ...
          <div className="hidden md:flex items-center space-x-2">
            <div className="relative ml-4">
              <input
                ...
                className="pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm w-64 transition-all duration-300 hover:border-primary-500 hover:shadow-md"
              />
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 transition-colors duration-300 hover:text-primary-500" size={20} />
            </div>
          </div>
        </div>
          ...
          <div className="px-4 pt-2 pb-4 space-y-2">
            <div className="relative mb-4">
              <input
                type="text"
                placeholder="Search Spaces..."
                className="w-full pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm transition-all duration-300 hover:border-primary-500"
              />
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 transition-colors duration-300 hover:text-primary-500" size={20} />
            </div>
            <Link 
